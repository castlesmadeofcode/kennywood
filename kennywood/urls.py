...
# default router knows when you go to / to use list
#  and when you go to /id use retrieve
# ^same as path('parkareas/', ParkAreas.list, '')
# path('parkareas/:park_area_id' ,ParkAreas.retrieve. '')
